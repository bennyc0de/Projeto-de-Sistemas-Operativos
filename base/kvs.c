...
int write_pair(HashTable *ht, const char *key, const char *value)
{
    ...
    // Nodes always exist because they are initialized in the control_lock function
...
char *read_pair(HashTable *ht, const char *key)
{
    ...
    // control lock initializes the nodes with the searched key and the value to NULL
    while (keyNode != NULL)
    {
        if (strcmp(keyNode->key, key) == 0 && keyNode->key != NULL)
        {
